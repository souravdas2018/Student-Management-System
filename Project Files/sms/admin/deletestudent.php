...
<body>
    <div class="container-fluid banner">
        ...
        <nav class="nav nav-pills nav-fill">
            ...
            <a class="nav-item nav-link active" href="deletestudent.php">DELETE DETAILS</a>
            ...
            <div class="container-fluid" style="margin-bottom: 20px;">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <form method="POST" action="deletestudent.php" style="margin-top: 15px;">
...
<table class="bg-primary" align="center" width="80%" style="margin-top: 10px; margin-bottom: 40px;">
    ...
    if(isset($_POST['submit']))
    {
        ...
        ?>
            ...
            <tr align="center">
                ...
                <td><a class="btn btn-danger" href="deleteform.php?sid=<?php echo $data['id'];?>">DELETE</a></td>
            </tr>
